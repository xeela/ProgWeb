...
<html>
    ...
    <body class="bodyStyle">
                        ...
                        <div class="searchBar col-xs-12 col-lg-7">
                            <div class="input-group">
                                ...
                                <div class="input-group-btn">
                                  ...
                                  <a class="btn btn-default" type="button" onclick="cercaProdotto('txtCerca')">Cerca</a> <!-- **** href è temporaneo, andrà sostituito con la chiamanta alla servlet che genera la pagina search in base al dato passato -->
                                </div><!-- /btn-group --> 
                            </div><!-- /input-group -->
                        </div>                     
        ...
        <script>
            ...
            {
                window.location = "searchPage.jsp?p=" + document.getElementById(txt).value;
            }
        </script>
    </body>
</html>
