        ...
        <div class="container-fluid">
            ...
            <div class="col-xs-12 col-lg-10">
               ...
               <div>
                    ...
                    <FORM ENCTYPE='multipart/form-data' method='GET' action='ServletEditUser'>
                        <p>Nome</p>  <input type="text" name="nome" placeholder="Nome"/>
                        <br></br>
                        <p>Cognome</p>  <input type="text" name="cognome" placeholder="Cognome"/>
                        <br></br>
                        ...
                        <div class="input-group">
                            <input id="pwdRegister" type="password" name="oldPassword" class="form-control" placeholder="Vecchia Password" aria-describedby="sizing-addon2">
                        ...
                        <p>Nuova Password</p>
                        <div class="input-group">
                            <input id="pwdRegister" type="password" name="newPassword" class="form-control" placeholder="Nuova Password" aria-describedby="sizing-addon2">
                            <span class="input-group-btn">
                                <a id="btnpwdRegister" class="btn btn-default" type="button" title="Mostra password" onclick="show_hide_pass('pwdRegister')">
                                    <span id="spanpwdRegister" class="glyphicon glyphicon-eye-open"></span>
                                </a>
                        ...
                        <div class="input-group">
                            <input id="pwdRegister" type="password" name="confirmPassword" class="form-control" placeholder="Conferma Password" aria-describedby="sizing-addon2">
                            <span class="input-group-btn">
                                <a id="btnpwdRegister" class="btn btn-default" type="button" title="Mostra password" onclick="show_hide_pass('pwdRegister')">
                                    <span id="spanpwdRegister" class="glyphicon glyphicon-eye-open"></span>
                                </a>
