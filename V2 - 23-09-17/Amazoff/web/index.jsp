        ...
        <div class="container-fluid">
            ...
            <div class="col-xs-12 col-lg-10">
                ...
                <div class="row" > <!-- style="position: fixed; z-index: 999;" -->
                        ...
                        <div class="logo col-xs-12 col-lg-1">
                            <div class="row">
                                <div class="col-xs-8 col-lg-10">LOGO</div>
                                <div class="col-xs-2 hidden-lg" style="text-align: right"> <spam class="glyphicon glyphicon-user"></spam></div>
                        ...
                        <div class="searchBar col-xs-12 col-lg-7">
                            <div class="input-group">
                                ...
                                <div class="input-group-btn">
                                  ...
                                  <ul class="dropdown-menu dropdown-menu-left hidden-xs"> <!-- ?????????? sull'ipad non sparisce -->
            ...
            <div class="col-lg-4 col-md-6 mb-4">
              <div class="card h-100">
                ...
                <div class="row">
                    <form class="col-md-12" id="LoginForm" name="LoginForm" action="ServletLogin" method="POST">
