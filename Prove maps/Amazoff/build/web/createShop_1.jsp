        ...
        <div class="container-fluid">
            ...
            <div class="col-xs-12 col-lg-10">
               ...
               <div>
                    ...
                    <h1>Dati Negozio</h1>
                    <FORM id="myform" onsubmit="initialize()" ENCTYPE='multipart/form-data' method='GET' action='ServletEditUser'>
                        ...
                        <!--<input type="text" name="coordinate" hidden="false" id="info"/>--><br/><br/><br/><br/><br/><br/><br/><br/><br/>
                        
                        <input type="hidden" name="coordinate" id="info" value="a"></input>
