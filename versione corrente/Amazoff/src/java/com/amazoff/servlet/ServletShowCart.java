...
/**
 * Recupera il carrello per utenti loggati o i dati dei prodotti inseriti nel
 * carrello per utenti non loggati.
 *
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (MyDatabaseManager.cpds != null) {
                ...
                if (session.getAttribute("userID") != null) {
                    /**
                     * Dopo aver inserito il nuovo prodotto, mi faccio
                     * restituire tutta la lista di oggetti presenti nel
                     * carrello
                     */
                    ...
                    /**
                     * ALTRIEMTI: aggiungo i dati del prodotti ad un oggetto
                     * json
                     */
                    ...
                    while (results.next()) {
                        if (!isFirstTime) /**
                         * metto la virgola prima dell'oggetto solo se non è il
                         * primo
                         */
                        {
                            jsonObj += ", ";
                        ...
                        /**
                         * in base al prodotto, ricavo il path delle img a lui
                         * associate, così da poterci accedere dalla pagina che
                         * usa questo json
                         */
                    ...
                    /**
                     * Se l'utente non è loggato, estraggo i dati del carrello,
                     * dai cookie
                     */
                    ...
                    if (cart != null) {
                        ...
                        for (int i = 0; i < cart.length - 1; i++) {
                            if (!isFirstTime) /**
                             * metto la virgola prima dell'oggetto solo se non è
                             * il primo
                             */
                            {
                                jsonObj += ", ";
